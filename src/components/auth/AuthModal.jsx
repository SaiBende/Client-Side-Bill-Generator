      ...
      <div className="bg-white sm:rounded-xl shadow-xl w-full sm:max-w-md sm:mb-0 max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6">
          <div className="text-center mb-6">
            <h2 className="text-xl font-bold text-gray-900">Welcome to ShareMyBill</h2>
            <p className="text-gray-500 text-sm mt-1">
              {local ? 'Create an account stored on this PC (works offline)' : 'Sign in to save & manage your invoices'}
            </p>
          </div>
          ...
          <p className="mt-6 pt-4 border-t border-gray-100 text-center text-[11px] text-gray-400">
            Made by{' '}
            <a href="https://saibende.vercel.app" target="_blank" rel="noreferrer" className="text-gray-500 hover:text-blue-600 font-medium">Sai Bende</a>
            {' · '}
            <a href="https://github.com/saibende" target="_blank" rel="noreferrer" className="text-gray-500 hover:text-blue-600">GitHub</a>
            {' · '}
            <a href="https://saibende.vercel.app" target="_blank" rel="noreferrer" className="text-gray-500 hover:text-blue-600">Portfolio</a>
          </p>
        </div>
      </div>
    </div>
